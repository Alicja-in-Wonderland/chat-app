...
import { getDownloadURL, ref, uploadBytes, userID } from "firebase/storage";
...
const CustomActions = ({ wrapperStyle, iconTextStyle, onSend, storage }) => {
    ...
    return (
        <TouchableOpacity style={styles.container} onPress={onActionPress} accessibilityLabel="More options"
